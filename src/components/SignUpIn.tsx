    ...
    return(
        ...
        <div className="grid place-items-center p-2 w-11/12 mx-auto">
                ...
                <p className="text-lg">Sign Up for CourseBlast!</p>
                    ...
                    <input id="name" type='name' required placeholder="Username" className="outline-none p-2 md:w-8/12 rounded-md border-2 border-emerald-700 indent-2 my-2"/>

                    <label htmlFor="password" className="block font-bold text-xl">Password</label>
                    <input id="password" type='password' required minLength={8} placeholder="Set a Password" className="p-2 peer md:w-8/12 rounded-md border-2 border-emerald-700 outline-none indent-2 my-2"/>
